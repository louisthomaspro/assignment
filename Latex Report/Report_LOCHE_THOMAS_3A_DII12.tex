...
%A travers ce projet, nous verrons comment nous avons choisi de résoudre ce problème d'affectation afin que chacun soit satisfait de son affectation.
...
\section{Code GMPL pour le modèle mathématique d'affectation}
\label{src:gmpl_source_model}
\javasourcefile{ressources/mathprog_model.txt}


\section{Notice d'installation et d'utilisation de l'outils google sheet}
\label{src:notice_utilisation}
